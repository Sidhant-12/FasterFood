    ...
    <div style={{backgroundImage: `url(${require('../components/images/LoginBg.jpg')})`, height: '100vh', backgroundSize: 'cover' }}>
      ...
      <div className='container'>
        ...
        <form onSubmit={handleSubmit} >
          ...
          <div className="mb-3">
            <label htmlFor="exampleInputEmail1" className="form-label text-white fs-3">Email address</label>
          ...
          <div className="mb-3">
            <label htmlFor="exampleInputPassword1" className="form-label  text-white fs-3">Password</label>
